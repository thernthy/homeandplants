<?php namespace App\Http\Controllers;
	...
	class AdminLocalizationsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"En-US","name"=>"en-US"];
			$this->col[] = ["label"=>"Km-KH","name"=>"km-KH"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Key','name'=>'key','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'En-US','name'=>'en-US','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Km-KH','name'=>'km-KH','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
